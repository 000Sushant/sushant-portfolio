...
export function GamingSticker({ className = "" }: StickerProps) {
  return (
    <div className={`absolute rotate-[-15deg] z-0 scale-[0.6] xs:scale-75 sm:scale-100 transition-all duration-300 hover:scale-110 hover:-translate-y-2 hover:rotate-[-6deg] cursor-pointer select-none group ${className}`}>
      <div className="bg-white border-2 border-pencil px-3 py-2 rounded-2xl shadow-[4px_4px_0px_rgba(0,0,0,0.15)] group-hover:shadow-[8px_8px_0px_rgba(0,0,0,0.15)] transition-all duration-300 flex flex-col items-center justify-center">
...
export function ShayariSticker({ className = "" }: StickerProps) {
  return (
    <div className={`absolute rotate-[6deg] z-0 scale-[0.6] xs:scale-75 sm:scale-100 transition-all duration-300 hover:scale-110 hover:-translate-y-2 hover:rotate-[12deg] cursor-pointer select-none group ${className}`}>
      <div className="bg-white border-2 border-pencil px-3.5 py-2 rounded-xl shadow-[4px_4px_0px_rgba(0,0,0,0.15)] group-hover:shadow-[8px_8px_0px_rgba(0,0,0,0.15)] transition-all duration-300 flex flex-col items-center justify-center">
        <svg viewBox="0 0 36 36" className="w-10 h-10 text-pencil mb-1" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
...
export function HikingSticker({ className = "" }: StickerProps) {
  return (
    <div className={`absolute rotate-[10deg] z-0 scale-[0.6] xs:scale-75 sm:scale-100 transition-all duration-300 hover:scale-110 hover:-translate-y-2 hover:rotate-[2deg] cursor-pointer select-none group ${className}`}>
      <div className="bg-white border-2 border-pencil px-3.5 py-2.5 rounded-2xl shadow-[4px_4px_0px_rgba(0,0,0,0.15)] group-hover:shadow-[8px_8px_0px_rgba(0,0,0,0.15)] transition-all duration-300 flex flex-col items-center justify-center">
        <svg viewBox="0 0 36 36" className="w-10 h-10 text-pencil mb-1" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
...
export function SwimmingSticker({ className = "" }: StickerProps) {
  return (
    <div className={`absolute rotate-[8deg] z-0 scale-[0.6] xs:scale-75 sm:scale-100 transition-all duration-300 hover:scale-110 hover:-translate-y-2 hover:rotate-[18deg] cursor-pointer select-none group ${className}`}>
      <div className="bg-white border-2 border-pencil px-3.5 py-2 rounded-xl shadow-[4px_4px_0px_rgba(0,0,0,0.15)] group-hover:shadow-[8px_8px_0px_rgba(0,0,0,0.15)] transition-all duration-300 flex flex-col items-center justify-center">
        <svg viewBox="0 0 36 36" className="w-10 h-10 text-pencil mb-1" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
...
export function SketchSticker({ className = "" }: StickerProps) {
  return (
    <div className={`absolute rotate-[-10deg] z-0 scale-[0.6] xs:scale-75 sm:scale-100 transition-all duration-300 hover:scale-110 hover:-translate-y-2 hover:rotate-[-2deg] cursor-pointer select-none group ${className}`}>
      <div className="bg-white border-2 border-pencil px-3.5 py-3 rounded-2xl shadow-[4px_4px_0px_rgba(0,0,0,0.15)] group-hover:shadow-[8px_8px_0px_rgba(0,0,0,0.15)] transition-all duration-300 flex flex-col items-center justify-center">
        <svg viewBox="0 0 36 36" className="w-10 h-10 text-pencil mb-1" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
...
export function SkateboardSticker({ className = "" }: StickerProps) {
  return (
    <div className={`absolute rotate-[-6deg] z-0 scale-[0.6] xs:scale-75 sm:scale-100 transition-all duration-300 hover:scale-110 hover:-translate-y-2 hover:rotate-[2deg] cursor-pointer select-none group ${className}`}>
      <div className="bg-white border-2 border-pencil px-3 py-2 rounded-xl shadow-[4px_4px_0px_rgba(0,0,0,0.15)] group-hover:shadow-[8px_8px_0px_rgba(0,0,0,0.15)] transition-all duration-300 flex flex-col items-center justify-center">
...
export function PhotographySticker({ className = "" }: StickerProps) {
  return (
    <div className={`absolute rotate-[-10deg] z-0 scale-[0.6] xs:scale-75 sm:scale-100 transition-all duration-300 hover:scale-110 hover:-translate-y-2 hover:rotate-[-2deg] cursor-pointer select-none group ${className}`}>
      <div className="bg-white border-2 border-pencil px-3 py-2.5 rounded-2xl shadow-[4px_4px_0px_rgba(0,0,0,0.15)] group-hover:shadow-[8px_8px_0px_rgba(0,0,0,0.15)] transition-all duration-300 flex flex-col items-center justify-center">
...
export function GuitarSticker({ className = "" }: StickerProps) {
  return (
    <div className={`absolute rotate-[15deg] z-0 scale-[0.6] xs:scale-75 sm:scale-100 transition-all duration-300 hover:scale-110 hover:-translate-y-2 hover:rotate-[5deg] cursor-pointer select-none group ${className}`}>
      <div className="bg-white border-2 border-pencil px-3.5 py-2.5 rounded-2xl shadow-[4px_4px_0px_rgba(0,0,0,0.15)] group-hover:shadow-[8px_8px_0px_rgba(0,0,0,0.15)] transition-all duration-300 flex flex-col items-center justify-center">
        <svg viewBox="0 0 36 36" className="w-10 h-10 text-pencil mb-1" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
...
export function SurfingSticker({ className = "" }: StickerProps) {
  return (
    <div className={`absolute rotate-[-12deg] z-0 scale-[0.6] xs:scale-75 sm:scale-100 transition-all duration-300 hover:scale-110 hover:-translate-y-2 hover:rotate-[6deg] cursor-pointer select-none group ${className}`}>
      <div className="bg-white border-2 border-pencil px-3 py-2.5 rounded-3xl shadow-[4px_4px_0px_rgba(0,0,0,0.15)] group-hover:shadow-[8px_8px_0px_rgba(0,0,0,0.15)] transition-all duration-300 flex flex-col items-center justify-center">
        <svg viewBox="0 0 36 36" className="w-10 h-10 text-pencil mb-1" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
...
export function CompassSticker({ className = "" }: StickerProps) {
  return (
    <div className={`absolute rotate-[-8deg] z-0 scale-[0.6] xs:scale-75 sm:scale-100 transition-all duration-300 hover:scale-110 hover:-translate-y-2 hover:rotate-[-2deg] cursor-pointer select-none group ${className}`}>
      <div className="bg-white border-2 border-pencil px-3.5 py-3 rounded-full shadow-[4px_4px_0px_rgba(0,0,0,0.15)] group-hover:shadow-[8px_8px_0px_rgba(0,0,0,0.15)] transition-all duration-300 flex flex-col items-center justify-center">
        <svg viewBox="0 0 36 36" className="w-10 h-10 text-pencil mb-1" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
...
export function BallSticker({ className = "" }: StickerProps) {
  return (
    <div className={`absolute rotate-[10deg] z-0 scale-[0.6] xs:scale-75 sm:scale-100 transition-all duration-300 hover:scale-110 hover:-translate-y-2 hover:rotate-[16deg] cursor-pointer select-none group ${className}`}>
      <div className="bg-white border-2 border-pencil px-3.5 py-2.5 rounded-2xl shadow-[4px_4px_0px_rgba(0,0,0,0.15)] group-hover:shadow-[8px_8px_0px_rgba(0,0,0,0.15)] transition-all duration-300 flex flex-col items-center justify-center">
...
export function BikeSticker({ className = "" }: StickerProps) {
  return (
    <div className={`absolute rotate-[12deg] z-0 scale-[0.6] xs:scale-75 sm:scale-100 transition-all duration-300 hover:scale-110 hover:-translate-y-2 hover:rotate-[4deg] cursor-pointer select-none group ${className}`}>
      <div className="bg-white border-2 border-pencil px-3.5 py-2.5 rounded-xl shadow-[4px_4px_0px_rgba(0,0,0,0.15)] group-hover:shadow-[8px_8px_0px_rgba(0,0,0,0.15)] transition-all duration-300 flex flex-col items-center justify-center">
        <svg viewBox="0 0 36 36" className="w-10 h-10 text-pencil mb-1.5" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
...
export function CoffeeSticker({ className = "" }: StickerProps) {
  return (
    <div className={`absolute rotate-[-6deg] z-0 scale-[0.6] xs:scale-75 sm:scale-100 transition-all duration-300 hover:scale-110 hover:-translate-y-2 hover:rotate-[4deg] cursor-pointer select-none group ${className}`}>
      <div className="bg-white border-2 border-pencil px-3.5 py-2.5 rounded-2xl shadow-[4px_4px_0px_rgba(0,0,0,0.15)] group-hover:shadow-[8px_8px_0px_rgba(0,0,0,0.15)] transition-all duration-300 flex flex-col items-center justify-center">
        <svg viewBox="0 0 36 36" className="w-10 h-10 text-pencil mb-1" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
...
export function MusicSticker({ className = "" }: StickerProps) {
  return (
    <div className={`absolute rotate-[12deg] z-0 scale-[0.6] xs:scale-75 sm:scale-100 transition-all duration-300 hover:scale-110 hover:-translate-y-2 hover:rotate-[-4deg] cursor-pointer select-none group ${className}`}>
      <div className="bg-white border-2 border-pencil px-3.5 py-2 rounded-full shadow-[4px_4px_0px_rgba(0,0,0,0.15)] group-hover:shadow-[8px_8px_0px_rgba(0,0,0,0.15)] transition-all duration-300 flex flex-col items-center justify-center">
        <svg viewBox="0 0 36 36" className="w-10 h-10 text-pencil mb-1.5" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
...
export function RobotSticker({ className = "" }: StickerProps) {
  return (
    <div className={`absolute rotate-[8deg] z-0 scale-[0.6] xs:scale-75 sm:scale-100 transition-all duration-300 hover:scale-110 hover:-translate-y-2 hover:rotate-[-8deg] cursor-pointer select-none group ${className}`}>
      <div className="bg-white border-2 border-pencil px-3.5 py-2.5 rounded-2xl shadow-[4px_4px_0px_rgba(0,0,0,0.15)] group-hover:shadow-[8px_8px_0px_rgba(0,0,0,0.15)] transition-all duration-300 flex flex-col items-center justify-center">
        <svg viewBox="0 0 36 36" className="w-10 h-10 text-pencil mb-1" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
